...
<head>
    ...
    <title>Browse Categories - Smart Library</title>
    ...
    <div class="container">
        ...
        if (isset($_GET['type'])) {
            ...
            <div class='category-header'>
                <h1>📖 $search_query</h1>
                <p>Browse our collection of $search_query books</p>
            </div>
            ";
            ...
            if ($run_pro && mysqli_num_rows($run_pro) > 0) {
                ...
                <div class='no-results'>
                    ...
                    <p>We couldn't find any books in the <strong>$search_query</strong> category.</p>
