...
<head>
    ...
    <title>Librarian Registration Portal</title>
    ...
    <script>
        function state() {
            ...
            // Corrected: changed nmae to name
    ...
    <style>
        * {
        ...
        /* Registration Header */
        .registration-header {
            /* Using a Farmer-appropriate color scheme (e.g., green/earth tones) */
        ...
        .form-group label i {
            color: #667eea; /* Adjusted icon color for contrast */
            font-size: 1.1rem;
        }
        ...
        .form-control:focus {
            border-color: #667eea; /* Adjusted focus color */
        ...
        /* Select Dropdown Adjustment for height consistency */
        .form-control.custom-select {
            padding-top: 12px;
            padding-bottom: 12px;
            height: auto; /* Ensure height matches input fields */
        }
        ...
        /* Footer - Kept UserRegistration Style for consistency */
        .myfooter {
...
<body>
    ...
    <div class="registration-header">
        ...
        <p>Join the Librarian Portal to sell your produce</p>
    </div>

    <div class="container">
        <div class="registration-container">
            <h2>Librarian Registration Form</h2>
            ...
            <form name="my-form" action="FarmerRegister.php" method="post">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select name="statevalue" id="states" onchange="state()" class="form-control custom-select" required>
...
if (isset($_POST['register'])) {
    // Note: The original PHP backend expects 'account' and 'pan', which were not in the old HTML.
    // I have added them as hidden fields above for the code to run without error.
