...
<head>
    ...
    <style>
        * {
        ...
        .error-message {
            /* Kept in case you implement PHP error handling like UserLogin.php */
            background: #fee;
...
<body>
    ...
    <div class="login-container">
        <div class="login-header">
            ...
            <p>Welcome back! Please login to your librarian account</p>
        </div>
        ...
        <div class="login-body">
            <form name="my-form" action="LibrarianLogin.php" method="post">
                ...
                <div class="login-footer">
                    <a href="FarmerForgotPassword.php">
