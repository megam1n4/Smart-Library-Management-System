...
<body>
    ...
    <nav class="navbar navbar-expand-xl">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="list-group moblists">
                <?php
                if (isset($_SESSION['phonenumber'])) {
                    echo "<a href='LibrarianProfile.php' class='list-group-item list-group-item-action ' >Profile</a>"; // Updated link for consistency
                    ...
                    echo "<a href='ExhibitionPost.php' class='dropdown-item'>Post Meet & Greet</a>"; // Updated text for consistency
    ...
    <div class=content_item>
        ...
        if (isset($_SESSION['phonenumber'])) {
            ...
            echo "<a href='../auth/LibrarianLogin.php'>
            <button class='btn btn-add-new p-3 m-3'>Add New Book <i class='fas fa-plus-square p-2 fa-1x'></i>
            </button>
            </a>";
        }
