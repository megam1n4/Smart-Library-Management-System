...
<div class=" flex-row-reverse left ">
    ...
    <a class="float-left" href="UserHome.php">
                        ...
                        <div class="row">
                            <div class="col-md-12" style="margin-top:35px;">
                                <span style="padding:15px;">
                                    <h4 id="full_name" class=""><img src="iconsmall.png" style="width: 28px; margin-bottom:  10px;"><b> FARMER </b></h4>
                                </span>
                                <span style="padding:15px;">
                                    <h4 id="full_name" style="margin-left:-9%;"><img src="phoneicon.jpg" style="width: 32px; margin-bottom:  10px;"><b> 8169193101 </b></h4>
                                </span>
                                <span style="padding:15px;">
                                    <h4 id="full_name" class=""><img src="location.jpg" style="width: 32px; margin-bottom:  10px;"><b> Dallas, Texas</b></h4>
                                </span>
                            </div>
                        </div>
					</div>
        ...
        <div class="row BigBox">
            <div class='col col-12 col-sm-12 col-md-4 col-xl-4 col-lg-4'>
                <div class='card pb-1 pl-1 pr-1 pt-0' style='height:542px'>
                    ...
                    <a href='../UserPortal/ProductDetails.php?id=$product_id'>
                    ...
                    <div class='card-body pb-0'>
                        ...
                        <div class='row'>
                            <div class='col-1 col-xl-3 col-lg-2 col-md-2 col-sm-2'></div>
                                <div class='col-12 col-xl-6 col-lg-6 col-md-6  col-sm-12'>
                                    <a href='../UserPortal/UserHome.php?add_cart=$product_id' class='btn btn-warning border-secondary mr-1  ' style='color:black ;font-weight:50px;'>Add to cart<img src='carticons.png' height='20px'></a>
                                </div>
                            </div>
                        </div>
                    </div>
