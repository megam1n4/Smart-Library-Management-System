...
<div class="container" >
    ...
    <div class="text-center"><h2><b>Your Profile</h2></b></div>
        <div class="form">
            ...
            <div class="input-group mt-4 s">
                <div class="input-group-prepend ">
                    <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="fas fa-globe-americas mr-2"></i>City</span>
                </div>
    ...
    -->
	<button type="button" class="btn text-center d-flex mx-auto btn-lg" style="background-color:#292b2c;color:goldenrod" onclick="navigateToEditPage()">Edit Profile</button>
