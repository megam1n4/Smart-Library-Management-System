    ...
    <nav class="navbar navbar-expand-xl">
        ...
        <a class="float-left" href="farmerHomepage.php">
          ...
          <div class=content_item>
               <label style="font-size :30px; text-shadow: 1px 1px 1px gray;"><b>All Books</b></label>
               <?php
               include("../Includes/db.php");
               if (isset($_SESSION['phonenumber'])) {

                    echo "<a href='InsertProduct.php'>
                    <button class='btn btn-warning btn-lg p-3 m-3 font-weight-bold'>Add New Book <i class='fas fa-plus-square p-2 fa-1x'></i>
                    </button>
                    </a>";
               } else {
